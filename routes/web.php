...
use Ophim\ThemeXingKong\Controllers\ThemeXingKongController;
...
Route::group([
    ...
    Route::post(sprintf('/%s/{movie}/{episode}/report', config('ophim.routes.movie', 'phim')), [ThemeXingKongController::class, 'reportEpisode'])->name('episodes.report');
    Route::post(sprintf('/%s/{movie}/rate', config('ophim.routes.movie', 'phim')), [ThemeXingKongController::class, 'rateMovie'])->name('movie.rating');
